...
export function ArticleDetailHeader({ title, lastUpdated, readTime }: ArticleDetail) {
  return (
    <div>
      ...
      <div className="mt-8 flex flex-wrap items-center justify-between gap-4   border-light-border pt-6">
        <span className="font-display text-lg text-dark-surface">{readTime}</span>

        <div className="flex items-center gap-3">
          <span className="font-body text-xs font-semibold tracking-[0.15em] text-dark-surface">

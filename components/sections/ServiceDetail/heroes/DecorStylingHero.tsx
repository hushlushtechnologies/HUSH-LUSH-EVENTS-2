...
export function DecorStylingHero() {
      ...
      <Container>
        <div className="grid grid-cols-1 items-center gap-16 lg:grid-cols-2">
          ...
          <div className="relative hidden h-[720px] lg:block">
            <div className="pointer-events-none absolute  -left-10 -top-10 flex h-full w-16 items-center justify-center">
              <span
  ...
  className="absolute left-1/2 top-0 h-[520px] w-[360px] -translate-x-1/4 overflow-hidden rounded-t-[180px] border-2 border-light-primary"
>
  <Image
    src={images.main}
  ...
  />
            ...
            <motion.div
              ...
              className="absolute -right-16 top-20 h-[340px] w-[220px] overflow-hidden rounded-[999px] border-2 border-light-primary shadow-lg"
            >
              <Image
                src={images.small}

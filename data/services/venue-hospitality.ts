...
export const venueHospitalityHero = {
  ...
  images: [
    { id: "v1", src: "/images/services/venue-hospitality/photo-1.jpg", top: "6%", left: "28%", width: "170px", height: "220px" },
    { id: "v2", src: "/images/services/venue-hospitality/photo-2.jpg", top: "12%", left: "58%", width: "170px", height: "200px" },
    { id: "v3", src: "/images/services/venue-hospitality/photo-3.jpg", top: "38%", left: "8%", width: "170px", height: "210px" },
    { id: "v4", src: "/images/services/venue-hospitality/photo-4.jpg", top: "40%", left: "78%", width: "170px", height: "230px" },
    { id: "v5", src: "/images/services/venue-hospitality/photo-5.jpg", top: "68%", left: "24%", width: "170px", height: "210px" },
    { id: "v6", src: "/images/services/venue-hospitality/photo-6.jpg", top: "72%", left: "62%", width: "170px", height: "220px" },
  ],
};
...
export const venueHospitalityPortfolioItems: PortfolioItem[] = [
  {
    ...
    subtitle: "Venue",
    image: "/images/services/venue-hospitality/portfolio-1.jpg",
    categories: ["venue"],
    span: "large",
  },
  {
    ...
    title: "Annual Gala",
    subtitle: "Venue",
    image: "/images/services/venue-hospitality/portfolio-2.jpg",
    categories: ["venue"],
    span: "stacked",
  },
  {
    ...
    title: "Garden Soirée",
    subtitle: "Venue",
    image: "/images/services/venue-hospitality/portfolio-3.jpg",
    categories: ["venue"],
    span: "stacked",
  },
  {
    ...
    title: "Dinner Party",
    subtitle: "Venue",
    image: "/images/services/venue-hospitality/portfolio-4.jpg",
    categories: ["venue"],
    span: "third",
  },
  {
    ...
    subtitle: "Venue",
    image: "/images/services/venue-hospitality/portfolio-5.jpg",
    categories: ["venue"],
    span: "third",
  },
  {
    ...
    subtitle: "Venue",
    image: "/images/services/venue-hospitality/portfolio-6.jpg",
    categories: ["venue"],
    span: "third",
  },
  {
    ...
    title: "Wedding Film",
    subtitle: "Venue",
    image: "/images/services/venue-hospitality/portfolio-7.jpg",
    categories: ["venue"],
    span: "third",
  },
  {
    ...
    subtitle: "Venue",
    image: "/images/services/venue-hospitality/portfolio-8.jpg",
    categories: ["venue"],
    span: "third",
  },
  {
    ...
    title: "Event Reel",
    subtitle: "Venue",
    image: "/images/services/venue-hospitality/portfolio-9.jpg",
    categories: ["venue"],
    span: "third",
  },
];
